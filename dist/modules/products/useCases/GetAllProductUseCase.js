...
let GetAllProductUseCase = class GetAllProductUseCase {
    constructor(productsRepository) {
        this.productsRepository = productsRepository;
    }
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.productsRepository.getAll();
        });
    }
};
GetAllProductUseCase = __decorate([
...
//# sourceMappingURL=GetAllProductUseCase.js.map