...
exports.GetOneProductUseCase = void 0;
const types_1 = __importDefault(require("@shared/container/types"));
const AppError_1 = require("@shared/errors/AppError");
const inversify_1 = require("inversify");
let GetOneProductUseCase = class GetOneProductUseCase {
    ...
    execute(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!product)
                throw new AppError_1.AppError("Product was not found!");
            return product;
        });
    }
};
GetOneProductUseCase = __decorate([
...
//# sourceMappingURL=GetOneProductUseCase.js.map