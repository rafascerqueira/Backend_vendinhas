...
const UpdateOrderUseCase_1 = require("../useCases/UpdateOrderUseCase");
class UpdateOrderController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = request.params;
            const { productList } = request.body;
            const updateOrder = inversify_config_1.default.resolve(UpdateOrderUseCase_1.UpdateOrderUseCase);
