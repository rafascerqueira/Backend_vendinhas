...
const DeleteOrderUseCase_1 = require("../useCases/DeleteOrderUseCase");
class DeleteOrderController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = request.params;
            const orderRepo = inversify_config_1.default.resolve(DeleteOrderUseCase_1.DeleteOrderUseCase);
            yield orderRepo.execute(parseInt(id));
