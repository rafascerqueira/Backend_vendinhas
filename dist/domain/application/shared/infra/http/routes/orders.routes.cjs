...
CreateOrderUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_inversify6.inject)(types_default.OrdersRepository)),
  __decorateParam(1, (0, import_inversify6.inject)(types_default.CustomersRepository))
], CreateOrderUseCase);
...
DeleteOrderUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_inversify8.inject)(types_default.OrdersRepository))
], DeleteOrderUseCase);
...
GetAllOrdersUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_inversify10.inject)(types_default.OrdersRepository))
], GetAllOrdersUseCase);
...
GetOneOrderUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_inversify12.inject)(types_default.OrdersRepository))
], GetOneOrderUseCase);
