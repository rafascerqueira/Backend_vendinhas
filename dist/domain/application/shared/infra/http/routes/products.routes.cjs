...
CreateProductUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_inversify6.inject)(types_default.ProductsRepository))
...
DeleteProductUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_inversify8.inject)(types_default.ProductsRepository))
...
GetAllProductUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_inversify10.inject)(types_default.ProductsRepository))
...
GetOneProductUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_inversify12.inject)(types_default.ProductsRepository))
...
UpdateProductUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_inversify14.inject)(types_default.ProductsRepository))
