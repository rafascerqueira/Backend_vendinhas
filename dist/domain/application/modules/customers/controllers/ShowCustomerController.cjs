...
var ShowCustomerController_exports = {};
__export(ShowCustomerController_exports, {
  ShowCustomerController: () => ShowCustomerController
});
module.exports = __toCommonJS(ShowCustomerController_exports);
